...
- **周期清单（07-16 盘点）**：audit-drift 周报 draft 20 只（**#821 与 #823 同文档冲突,建议直接关**——classifier 挡自动关，owner 一键）· dependabot 10 只（#679 biome 2.x / #678 lucide 1.x / #680 testcontainers 12 三只 major 需人看）· 僵尸 cursor draft（#590/#588/#522/#465/#466）· `.claude/worktrees` 27 只契约波残留 worktree · 17 个 stash · 12 只 `tlp-yuk621-e2e-*` exited 容器。
