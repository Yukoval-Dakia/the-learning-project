// Domain event read models. These seven projections remain here until they migrate to their owning capabilities.
//
// Seven approved domain projections only; generic envelope storage lives in @/kernel/events.
