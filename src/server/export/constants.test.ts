...
describe('export constants', () => {
  it('SCHEMA_VERSION is "4.17" (YUK-791 intervention lineage enters backup)', () => {
    ...
    expect(SCHEMA_VERSION).toBe('4.17');
  });
  ...
  it('FK_ORDER lists all 50 tables in topological order', () => {
