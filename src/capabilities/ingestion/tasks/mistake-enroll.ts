...
2. question_type —— 从题面判题型的展示标签：优先取惯用标签 choice | true_false | fill_blank | short_answer | essay | computation | reading | translation | derivation（先判断答案类型——受限 exact / 关键词 keyword / 开放 semantic / 分步 steps——再选与题面结构一致的标签）。
