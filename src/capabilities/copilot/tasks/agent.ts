...
// moved verbatim from the central src/ai quarry. Output contract is the
// streamed reply text itself: the 2026-06-08 structured-output audit rules
// CopilotTask plain-text-ok (whole-reply JSON would destroy the YUK-266
