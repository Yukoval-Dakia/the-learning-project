...
- 顶层字段照常填：kind 与 plan 项一致；prompt_md / reference_md 写整题题面与合并答案（持久化以 structured 派生为准，但仍必填）；choices_md 填 null；judge_kind_override 填 "semantic"，rubric_json.required_points 必填（列出覆盖各小题的采分点），reference_solution.final_answer 写整题答案概述。
