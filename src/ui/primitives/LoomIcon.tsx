// LoomIcon — feather-style 24px stroke icon set, ported verbatim from
// docs/design/loom-prototype/components.jsx (ICONS + Icon). The path strings
// are the single source of truth for loom's iconography; render as an inline
// <svg> with a stroke-only feather look (size 18 / stroke 1.8 / viewBox 0 0 24 24).

import type { CSSProperties } from 'react';

// Feather-style 24px stroke paths. Keys are the loom icon vocabulary.
const ICONS = {
  ...
  mistakes:
    '<path d="M10.3 4.3 2.7 18a2 2 0 0 0 1.7 3h15.2a2 2 0 0 0 1.7-3L13.7 4.3a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',
  items: '<path d="M4 5h16"/><path d="M4 12h16"/><path d="M4 19h10"/>',
  knowledge:
    '<circle cx="6" cy="6" r="2.5"/><circle cx="18" cy="8" r="2.5"/><circle cx="9" cy="18" r="2.5"/><path d="M8 7.2 16 7.5M8 8 9 15.6M16 10l-6 6"/>',
  inbox:
  ...
  teach:
    '<path d="M3 7l9-4 9 4-9 4-9-4Z"/><path d="M7 9v5c0 1 2.2 2.5 5 2.5s5-1.5 5-2.5V9"/><path d="M21 7v6"/>',
  ...
  flame:
    '<path d="M12 3c2 3 5 4.5 5 8a5 5 0 0 1-10 0c0-1.4.6-2.4 1.4-3.2C8.9 9 9 11 12 11c0-2.5-1-5 0-8Z"/>',
  ...
  image:
    '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="2"/><path d="m5 19 5-5 3 3 2-2 4 4"/>',
  ...
  graph:
    '<circle cx="5" cy="6" r="2"/><circle cx="19" cy="9" r="2"/><circle cx="9" cy="18" r="2"/><circle cx="17" cy="19" r="2"/><path d="M6.7 7 17 8.5M7 7.5l1.6 8.6M10.8 18l5-1"/>',
  ...
  refresh:
    '<path d="M21 12a9 9 0 0 1-9 9 9 9 0 0 1-7-3.3M3 12a9 9 0 0 1 9-9 9 9 0 0 1 7 3.3"/><path d="M21 4v5h-5M3 20v-5h5"/>',
  settings:
    '<circle cx="12" cy="12" r="3"/><path d="M19.4 13a1.6 1.6 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.6 1.6 0 0 0-2.7 1.1V20a2 2 0 1 1-4 0v-.2a1.6 1.6 0 0 0-2.7-1.1l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1A1.6 1.6 0 0 0 4.6 13H4a2 2 0 1 1 0-4h.2a1.6 1.6 0 0 0 1.1-2.7l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.6 1.6 0 0 0 2.7-1.1V2a2 2 0 1 1 4 0v.2a1.6 1.6 0 0 0 2.7 1.1l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1A1.6 1.6 0 0 0 19.4 9H20a2 2 0 1 1 0 4h-.6Z"/>',
  spark2:
    '<path d="M5 3v4M3 5h4M6 17v4M4 19h4M13 3l2.5 6.5L22 12l-6.5 2.5L13 21l-2.5-6.5L4 12l6.5-2.5L13 3Z"/>',
  merge:
    '<path d="M7 3v4a5 5 0 0 0 5 5h5"/><path d="M7 21v-4a5 5 0 0 1 5-5"/><path d="m15 8 4 4-4 4"/>',
  undo: '<path d="M9 7 4 12l5 5"/><path d="M4 12h11a5 5 0 0 1 0 10h-1"/>',
  camera:
    '<path d="M4 8a2 2 0 0 1 2-2h1l1.2-2h5.6L17 6h1a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8Z"/><circle cx="12" cy="13" r="3.2"/>',
...
export function LoomIcon({ name, size = 18, className = '', style }: LoomIconProps) {
  const d = ICONS[name] || '';
  return (
    <svg
      ...
      style={style}
      aria-hidden="true"
      // biome-ignore lint/security/noDangerouslySetInnerHtml: icon path strings are static, in-module constants (no user input)
