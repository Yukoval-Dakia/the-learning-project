/**
 * task-catalog.ts — central composition root for all 50 TaskDefinition specs.
 *
 * YUK-863 / YUK-939 — Census and compose 50 owner TaskSpecs.
 *
...
/**
 * The composed, frozen catalog of all 50 TaskDefinitions.
