...
## 2. Axis 之争：该按哪个框架切？（决策回顾，非待拍板）

> **已拍板（owner 2026-06-16）**：6 类机制主轴 + 保留 representation_failure + Axis A 元认知做正交轴。以下是当时的备选权衡与选定理由，供实现者参考，**非开放问题**。
...
## 6. 三项分叉的权衡记录（owner 2026-06-16 已拍板）

> **三项均已拍板**：① 粒度 = 6 类 ② representation_failure = 保留独立 ③ Axis A = 正交轴。以下保留各分叉的权衡作决策理由记录，**非待拍板**。
