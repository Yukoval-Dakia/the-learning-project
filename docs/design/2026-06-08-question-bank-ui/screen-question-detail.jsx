        ...
        <div className="kd-main">
          ...
          {q.composite && (
            <div className="qd-sec">
              ...
              <div className="qd-passage" style={{ marginTop: "var(--s-3)" }}><QMarkdown text={q.passage} /></div>
            </div>
          )}
          ...
          <div className="qd-sec">
            ...
            <div className="qd-edit">
              ...
              <div className="qd-preview">
                <div className="qd-preview-tag"><Icon name="eye" size={12} />预览</div>
          ...
          <div className="qd-sec">
            ...
            <div className="qd-answer">
              <QMarkdown text={q.answer} />
              {q.answerNote && <div className="qd-note"><Icon name="sparkle" size={12} style={{ verticalAlign: -2, marginRight: 4, color: "var(--coral)" }} /><QInline text={q.answerNote} /></div>}
            </div>
          </div>
          )}
