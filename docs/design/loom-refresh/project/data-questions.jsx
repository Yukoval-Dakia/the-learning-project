...
// 科目 (subject) — derived from knowledge id prefix unless explicitly set
const QSUBJECT = {
...
function qSubject(q) {
  ...
  const k = (q.knowledge || [])[0] || "";
  if (k.indexOf("k_eng") === 0) return "eng";
  if (k.indexOf("k_math") === 0 || k === "k_suanxue") return "math";
  return "yuwen";
}
Object.assign(window, { QKIND, QSOURCE, QSTATUS, QDIFF, QKLABEL, qkLabel, QSUBJECT, qSubject });
