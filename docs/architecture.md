...
| `CopilotEvidenceReviewTask` | mimo-v2.5-pro | Copilot free-form turn 使用 DomainTool read 后、回复持久化/可见前（YUK-832） | 否 | — | 无工具、单轮、严格 Zod 的最终证据审阅；只比较当前请求、精确 typed tool trace 与 candidate，pass 保留原字节，repair 产独立安全回复，异常 fail closed |
