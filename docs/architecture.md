...
`(source file, resolved target module)`：capability → server 524、server → capability deep
67、cross-capability value 62；后者目前包含一个由 agency/ingestion/knowledge/notes/practice
