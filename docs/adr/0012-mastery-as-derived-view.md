...
**状态**：accepted
**日期**：2026-05-15
**Superseded by**: [ADR-0035](0035-mastery-diagnosis-three-dim-full-engine-instantiation.md)（占位计算公式） · **Amended by**: [ADR-0037](0037-unified-scheduling-merge-engine.md)（mastery 被 B1 `mastery_state` 重写；view 派生原则保留）
