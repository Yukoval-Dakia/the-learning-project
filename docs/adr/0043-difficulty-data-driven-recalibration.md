...
### b_anchor 来源 — feature-based 锚的 spike 裁决 + 框定纠正（2026-06-15，owner 复核）
spike 报告 `docs/design/2026-06-15-b-anchor-feasibility-spike.md`（5-agent，web 核源 + 对抗 critic）+ owner 复核纠正：
